...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute h-8 w-8 border-none bg-transparent hover:bg-transparent focus:bg-transparent",
        orientation === "horizontal"
          ? "-left-12 top-1/2 -translate-y-1/2 xl:-left-6"
  ...
  return (
    <Button
      ...
      className={cn(
        "absolute h-8 w-8 border-none bg-transparent hover:bg-transparent focus:bg-transparent",
        orientation === "horizontal"
          ? "-right-12 top-1/2 -translate-y-1/2 xl:-right-6"
