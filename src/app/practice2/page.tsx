      ...
      <div className="relative flex h-fit w-full items-center justify-center">
        ...
        <div className="absolute -top-24 h-full w-full">
          ...
          <div className="relative">
            <div className="absolute -top-[600px] left-52 h-[350px] w-[350px] appearance-none rounded-full bg-[#F73A4B] opacity-[15%] shadow-[rgba(247,58,75,100)_0px_0px_100px_150px] xl:left-10 sm:-top-[200px] sm:h-[100px] sm:w-[200px]"></div>
            <div className="absolute -top-[900px] right-48 h-[400px] w-[350px] appearance-none rounded-full bg-[#7000FF] opacity-[15%] shadow-[rgba(112,0,255,100)_0px_0px_100px_150px] xl:right-10 sm:-top-[500px] sm:h-[250px] sm:w-[250px]"></div>
