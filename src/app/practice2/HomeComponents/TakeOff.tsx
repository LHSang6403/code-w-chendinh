    ...
    <div className="my-44">
      <div className="flex flex-col items-center gap-6">
        ...
        <p className="-mt-2 text-center font-light text-[#9B999E]">
          Download the Raycast app and start taking your productivity<br></br>{" "}
          to new heights.
        </p>
        <div className="mt-2 h-fit w-fit rounded-[10px] bg-[#504D56] p-0.5">
          <Button className="w-60 bg-white">Download for Mac</Button>
        </div>
