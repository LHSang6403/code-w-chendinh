...
export default function LeftBanner() {
  return (
    <div className="z-10 flex h-fit w-1/2 justify-center px-32 xl:-ml-6 xl:mb-20 xl:w-full sm:-ml-12 sm:px-0">
