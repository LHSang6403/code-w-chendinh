...
export default function page() {
  return (
    <div className="flex h-auto w-full max-w-[1600px] flex-col overflow-hidden bg-[#F5F4F4]">
      ...
      <div className="flex flex-row items-center justify-between gap-10 px-6 pb-8 pt-16 xl:flex-col sm:px-4">
        <h1 className="text-4xl font-medium text-[#514B4B] sm:text-3xl">
          Want to make your business better? Contact us today!
        </h1>
        <p className="font-light text-[#898989]">
      ...
      <div className="z-10 px-6 pb-16 pt-4 sm:px-4">
        <div className="w-fit rounded-full bg-gradient-to-r from-[#1B377D] to-[#3060DB] px-6 py-1 text-3xl font-medium text-white xl:mx-auto sm:mx-4 sm:text-2xl">
        ...
        <div className="relative flex w-full flex-col items-center">
          ...
          <h1 className="mb-16 mt-12 text-3xl text-[#514B4B]">
